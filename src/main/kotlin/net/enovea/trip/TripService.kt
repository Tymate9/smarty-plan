...
class TripService(
    ...
    fun computeTripEventsDTO(vehicleId: String, date: String):
            Pair<Boolean, TripEventsDTO?> {
        ...
        val geolocalized = vehicle.geolocalized!!
        ...
        return Pair(geolocalized,result)
    }
