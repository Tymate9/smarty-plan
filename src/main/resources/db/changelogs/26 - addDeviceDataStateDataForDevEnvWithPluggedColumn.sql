...
-- changeset smarty_plan:26 context:dev

INSERT INTO device_data_state (device_id, state, first_comm_time, last_comm_time, last_received_data_time, last_position, last_position_time, address, state_time, plugged )
SELECT d.id,
